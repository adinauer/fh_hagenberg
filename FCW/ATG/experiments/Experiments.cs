// ATTENTION: Replace all occurences of "Experiments" by the compiler name! 

// Experiments.cs                                                        HDO, 2006-08-28
// -----
// Main program for compiler generated from Experiments.atg with Coco-2.
//=====================================|========================================
...
public class Experiments {
  ...
  private static String NAME = "Experiments";
  ...
  //-----------------------------------|----------------------------------------
    ...
    Utils.InstallModule("ExperimentsLex",  new Utils.ModuleMethodDelegate(ExperimentsLex.ExperimentsLexMethod));
    Utils.InstallModule("ExperimentsSem",  new Utils.ModuleMethodDelegate(ExperimentsSem.ExperimentsSemMethod));
    Utils.InstallModule("ExperimentsSyn",  new Utils.ModuleMethodDelegate(ExperimentsSyn.ExperimentsSynMethod));
