// ExperimentsSyn.cs                                              HDO, 2006-08-28
// -------------
...
using Sem = ExperimentsSem;

public class ExperimentsSyn {
                   
  public static String MODULENAME = "ExperimentsSyn";
  ...
  private const int ROOTPC     =   48;
  private const int LASTTERM   =    6;
  private const int LASTPRAGMA =    6;
  ...
  private class GrammarTable {
    ...
    public byte[] code = {
         4,   1,   1,   1,   2,  14,   0,   4,   1,   2,  10,   4,   0,   0,
         4,  15,  11,   2,   6,   1,   0,   1,  14,   4,   2,   3,   1,   3,
        37,   0,   4,   2,   4,  10,  27,   0,   8,   1,  11,   2,   6,   1,
         2,   5,   2,  15,  11,   4,   0,   1,   0,   0,  11
    };
    public NTData[] nts = {
      new NTData(   1, false, new Sets.Set256(0x0040)),
      new NTData(  18, false, new Sets.Set256(0x0040)),
      new NTData(  40, false, new Sets.Set256(0x0040))
    };
    public Sets.Set256[] epsSets = {
      new Sets.Set256(0x0014)
    };
    public Sets.Set256[] anySets = {
      new Sets.Set256(0x0000)
    };
    public String[] names = {
      "end of file", ":", ";", ",", ".", "number", "identifier",
      "Experiments", "Experiment", "Ingredient"
    };
  } // GrammarTable;
  ...
  public static void ExperimentsSynMethod(Utils.ModuleAction action, out String moduleName) {
  //-----------------------------------|----------------------------------------
