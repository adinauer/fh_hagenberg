// BinaryTreeSyn.cs                                              HDO, 2006-08-28
// -------------
...
using Sem = BinaryTreeSem;

public class BinaryTreeSyn {
                   
  public static String MODULENAME = "BinaryTreeSyn";
  ...
  private const int ROOTPC     =   35;
  private const int LASTTERM   =    3;
  private const int LASTPRAGMA =    3;
  ...
  private class GrammarTable {
    ...
    public byte[] code = {
        13,   0,   1,   4,   1,   2,   0,   2,  15,  11,   1,   1,  32,   0,
         4,   1,   1,   0,   2,   2,   3,   2,  15,   0,   1,   4,   1,   4,
         0,   2,  11,   8,   1,  11,   4,   0,   1,   0,   0,  11
    };
    public NTData[] nts = {
      new NTData(   1, false, new Sets.Set256(0x0002)),
      new NTData(  11, true , new Sets.Set256(0x0002))
    };
    public Sets.Set256[] epsSets = {
      new Sets.Set256(0x0004)
    };
    public Sets.Set256[] anySets = {
      new Sets.Set256(0x0000)
    };
    public String[] names = {
      "end of file", "(", ")", "number", "BinaryTree", "SubTree"
    };
  } // GrammarTable;
  ...
  public static void BinaryTreeSynMethod(Utils.ModuleAction action, out String moduleName) {
  //-----------------------------------|----------------------------------------
