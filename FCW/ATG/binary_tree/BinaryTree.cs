// ATTENTION: Replace all occurences of "BinaryTree" by the compiler name! 

// BinaryTree.cs                                                        HDO, 2006-08-28
// -----
// Main program for compiler generated from BinaryTree.atg with Coco-2.
//=====================================|========================================
...
public class BinaryTree {
  ...
  private static String NAME = "BinaryTree";
  ...
  //-----------------------------------|----------------------------------------
    ...
    Utils.InstallModule("BinaryTreeLex",  new Utils.ModuleMethodDelegate(BinaryTreeLex.BinaryTreeLexMethod));
    Utils.InstallModule("BinaryTreeSem",  new Utils.ModuleMethodDelegate(BinaryTreeSem.BinaryTreeSemMethod));
    Utils.InstallModule("BinaryTreeSyn",  new Utils.ModuleMethodDelegate(BinaryTreeSyn.BinaryTreeSynMethod));
