// GrammarTranslatorSyn.cs                                              HDO, 2006-08-28
// -------------
...
using Sem = GrammarTranslatorSem;

public class GrammarTranslatorSyn {
                   
  public static String MODULENAME = "GrammarTranslatorSyn";
  ...
  private const int ROOTPC     =  122;
  private const int LASTTERM   =   12;
  private const int LASTPRAGMA =   12;
  ...
  private class GrammarTable {
    ...
    public byte[] code = {
         5,   1,  11,   0,   1,   0,   9,  10,   1,   0,   8,   1,  14,  11,
         2,  11,   1,   0,   1,  14,   4,   2,   3,  16,  11,   4,   3,   1,
         1,   2,  39,   0,   4,   3,   2,  10,  29,   0,   8,   2,  11,  13,
         3,  11,  52,   0,   2,  15,  10,  43,   0,   3,  12,  61,   0,   4,
        17,  10,  43,   0,   9,   3,  72,   0,  18,   4,   4,   7,  10,  43,
         0,   9,   4,  83,   0,  20,   4,   5,   9,  10,  43,   0,   9,   5,
        95,   0,  22,   4,   6,  11,  24,  10,  43,   0,   8,   6,  11,   0,
         7,   4,   2,   1,   0,   8,  11,   0,   3,   4,   2,   1,   0,   4,
        11,   0,   5,   4,   2,   1,   0,   6,  11,   4,   0,   1,   0,   0,
        11
    };
    public NTData[] nts = {
      new NTData(   1, true , new Sets.Set256(0x0800)),
      new NTData(  15, false, new Sets.Set256(0x0800)),
      new NTData(  26, true , new Sets.Set256(0x18ac)),
      new NTData(  42, true , new Sets.Set256(0x18a8)),
      new NTData(  98, false, new Sets.Set256(0x0080)),
      new NTData( 106, false, new Sets.Set256(0x0008)),
      new NTData( 114, false, new Sets.Set256(0x0020))
    };
    public Sets.Set256[] epsSets = {
      new Sets.Set256(0x0001),
      new Sets.Set256(0x0350),
      new Sets.Set256(0x0080),
      new Sets.Set256(0x0008),
      new Sets.Set256(0x0020),
      new Sets.Set256(0x0354)
    };
    ...
    public String[] names = {
      "end of file", "=", "|", "[", "]", "{", "}", "(", ")", ".", "number",
      "nonterminal", "terminal", "GrammarTranslator", "Rule",
      "Alternatives", "Alternative", "Grouping", "Optional", "Repetition"
    };
  } // GrammarTable;
...
} // GrammarTranslatorSyn
 
// End of GrammarTranslatorSyn.cs
//=====================================|========================================