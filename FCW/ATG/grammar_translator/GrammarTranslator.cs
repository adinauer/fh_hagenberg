// ATTENTION: Replace all occurences of "GrammarTranslator" by the compiler name! 

// GrammarTranslator.cs                                                        HDO, 2006-08-28
// -----
// Main program for compiler generated from GrammarTranslator.atg with Coco-2.
//=====================================|========================================
...
public class GrammarTranslator {
  ...
  private static String NAME = "GrammarTranslator";
  ...
  //-----------------------------------|----------------------------------------
    ...
    Utils.InstallModule("GrammarTranslatorLex",  new Utils.ModuleMethodDelegate(GrammarTranslatorLex.GrammarTranslatorLexMethod));
    Utils.InstallModule("GrammarTranslatorSem",  new Utils.ModuleMethodDelegate(GrammarTranslatorSem.GrammarTranslatorSemMethod));
    Utils.InstallModule("GrammarTranslatorSyn",  new Utils.ModuleMethodDelegate(GrammarTranslatorSyn.GrammarTranslatorSynMethod));
